export const HOW_TO_USE_CONTENT = {
  es: {
    ...
    empty: 'No hay resultados para esa búsqueda. Prueba con otra palabra clave o revisa el índice de módulos.',
    allModules: 'Todos',
    results: '{{count}} secciones visibles',
  ...
  en: {
    ...
    empty: 'No results for that search. Try another keyword or use the module index.',
    allModules: 'All',
    results: '{{count}} visible sections',
